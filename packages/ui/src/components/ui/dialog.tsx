...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // shadow-modal is the deeper, warm-toned elevation token (tokens.css) meant for exactly
        // this — a surface floating well above the page, distinct from --shadow-card's lighter
        // lift — swapped in for Shadcn's generic default `shadow-lg`. ConfirmDialog and every
        // other Dialog-based component (ui/) pick this up automatically.
