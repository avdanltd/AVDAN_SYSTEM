...
import { otpSchema, type OtpInput } from '../schemas/auth.schemas'
            ...
            <Form {...otpForm}>
              <form
                onSubmit={otpForm.handleSubmit((d) =>
                  verifyMutation.mutate({ user_id: userId, otp: d.otp }),
                )}
                className="space-y-4"
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="000000" maxLength={6} {...field} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
