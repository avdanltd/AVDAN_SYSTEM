 ...
 *
 * Deliberately verify-before-save: the rider picks a bank and types an account number, we
        ...
        {existing?.has_payout_account ? (
          ...
          <Card style={[styles.warnCard, { backgroundColor: colors.warningMuted }]}>
            ...
            <Text style={[styles.warnBody, { color: colors.mutedForeground }]}>
              Your delivery fees stay unpaid until a verified bank account is on file. Add one to
